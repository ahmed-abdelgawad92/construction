		...
		<div class="panel-body">
			...
			<form method="post" action="{{ route('addtax') }}" class="form-horizontal" id="add_tax">
				...
				<div class="form-group row @if($errors->has('name')) has-error @endif">
					...
					<div class="col-sm-8 col-md-8 col-lg-8">
						<input type="text" name="name" id="name" value="{{old('name')}}" class="form-control" placeholder="أدخل أسم هذه الأستقطاع" autocomplete="off">
						@if($errors->has('name'))
				...
				<div class="form-group row @if($errors->has('value')||$errors->has('type')) has-error @endif">
					<label for="value" class="control-label col-sm-2 col-md-2 col-lg-2">نسبة الأستقطاع</label>
					<div class="col-sm-8 col-md-8 col-lg-8">
						<div class="input-group w-100">
						<input type="text" name="value" id="value" value="{{old('value')}}" class="form-control input-right" style="width:85% !important;" placeholder="أدخل قيمة أو نسبة الأستقطاع" autocomplete="off">
