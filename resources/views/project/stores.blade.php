					...
					@foreach($stores as $store)
						<tr>
							...
							<th>
								...
								<a href="{{route("addPaymentToStore",['id'=>$store->id])}}" data-allowed-amount="{{($store->amount*$store->value)-$store->amount_paid}}" class="btn btn-success add_payment_to_store width-100">أدفع</a>
								@else
								<div class="state center width-100">خالص</div>
								@endif
